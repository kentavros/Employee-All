({
	itemSelected : function(component, event, helper) {
		...
		var cmpEvent = component.getEvent("accountSearch");
		cmpEvent.setParams({'accountId':selItem.val});
    ...
    clearSelection: function(component, event, helper){
		...
		var cmpEvent = component.getEvent("clearAccountSearch");
		cmpEvent.setParams({'clearStatus':true});
		cmpEvent.fire(); // возбуждаем event
    } 
})